...
with DAG(
    ...
    upload_vector_wm = KubernetesPodOperator(
        ...
        namespace="tiles",
        cmds=["/bin/bash"],
        arguments=["-c", "azcopy login --identity --identity-client-id 60efcd71-1ca4-4650-ba7b-66f04c720d75; azcopy copy '/var/cache/mvtcache/wm/*' https://piosupportstor.blob.core.windows.net/tiles/wm/vector/ --recursive --content-encoding gzip --content-type application/vnd.mapbox-vector-tile"],
    ...
    upload_vector_rd = KubernetesPodOperator(
        ...
        namespace="tiles",
        cmds=["/bin/bash"],
        arguments=["-c", "azcopy login --identity --identity-client-id 60efcd71-1ca4-4650-ba7b-66f04c720d75; azcopy copy '/var/cache/mvtcache/rd/*' https://piosupportstor.blob.core.windows.net/tiles/rd/vector/ --recursive --content-encoding gzip --content-type application/vnd.mapbox-vector-tile"],
