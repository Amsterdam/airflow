...
with DAG(
    ...
    mapproxy_generate_tiles_rd = KubernetesPodOperator(
        ...
        namespace="airflow",
        arguments=["mapproxy-seed", "-c", "16", "-s", "/var/config/seed.yaml", "-f", "/var/config/mapproxy.yaml", "--seed=rd_kbk"],
    ...
    mapproxy_generate_tiles_rd_zw = KubernetesPodOperator(
        ...
        image="dsoapi.azurecr.io/mapproxy",
        namespace="airflow",
        arguments=["mapproxy-seed", "-c", "16", "-s", "/var/config/seed.yaml", "-f", "/var/config/mapproxy.yaml", "--seed=rd_kbk_zw"],
    ...
    mapproxy_generate_tiles_rd_light = KubernetesPodOperator(
        ...
        image="dsoapi.azurecr.io/mapproxy",
        namespace="airflow",
        arguments=["mapproxy-seed", "-c", "16", "-s", "/var/config/seed.yaml", "-f", "/var/config/mapproxy.yaml", "--seed=rd_kbk_light"],
